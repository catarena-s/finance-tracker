...
- Frontend: Dashboard компоненты
  - SummaryCards с отображением доходов, расходов и баланса
  - Dashboard страница с интеграцией аналитики
- Frontend: Layout компоненты
  - Header с навигацией и гамбургер-меню
  - Footer с копирайтом и ссылками
  - Корневой Layout с интеграцией всех компонентов
- Frontend: страницы и роутинг
  - Страница транзакций с модальными окнами CRUD
  - Страница категорий с предупреждением о связанных транзакциях
  - Страница бюджетов с отображением прогресса
  - Главная страница с навигацией
  - Dashboard страница
  - Next.js App Router настроен и работает
