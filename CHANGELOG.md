...
### Ключевые изменения (Настройки приложения, Административные API)
...
- **Тесты:** добавлены тесты для API настроек и административных задач; все 89 backend тестов проходят.
