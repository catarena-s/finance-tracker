...
- [ ] 2. Исправить адаптивность карточек баланса (BalanceCards)
  ...
  - [~] 2.3 Написать property-тест для адаптивных размеров шрифтов
    - **Свойство 2: Адаптивные размеры шрифтов**
    - **Валидирует: Требования 1.2, 6.1**
  
  - [~] 2.4 Написать property-тест для минимальных отступов
    - **Свойство 3: Минимальные отступы контейнеров**
    - **Валидирует: Требования 1.4, 6.3**
  
  - [~] 2.5 Написать property-тест для пропорций иконок
...
- [ ] 3. Исправить адаптивность фильтров на дашборде
  ...
  - [~] 3.2 Написать property-тест для вертикального расположения фильтров
    - **Свойство 5: Вертикальное расположение фильтров**
    - **Валидирует: Требования 2.1, 6.2**
  
  - [~] 3.3 Написать property-тест для минимальных размеров интерактивных элементов
    - **Свойство 6: Минимальные размеры интерактивных элементов**
    - **Валидирует: Требования 2.4, 4.5, 5.4, 7.2, 9.3**
  
  - [~] 3.4 Написать property-тест для адаптивных меток кнопок
    - **Свойство 7: Адаптивные метки кнопок**
    - **Валидирует: Требования 2.5**

- [ ] 4. Checkpoint - Проверка базовой адаптивности
...
- [ ] 5. Исправить адаптивность графиков
  ...
  - [~] 5.2 Обновить компонент TrendChart с адаптивными настройками
  ...
  - [~] 5.3 Обновить компонент TopCategoriesWidget с адаптивными настройками
    - Добавить динамическую высоту `h-64 sm:h-80 lg:h-96`
    - Применить адаптивные настройки Chart.js
    - _Требования: 3.1, 3.2, 3.3, 3.4_
  
  - [~] 5.4 Написать property-тест для минимальной высоты графиков
    - **Свойство 8: Минимальная высота графиков**
    - **Валидирует: Требования 3.2**
  
  - [~] 5.5 Написать property-тест для адаптивного количества меток
    - **Свойство 9: Адаптивное количество меток на осях**
    - **Валидирует: Требования 3.4**
  
  - [~] 5.6 Написать unit-тест для интерактивности графиков на сенсорных экранах
    - Проверить, что tooltip появляется при touch событиях
    - _Требования: 3.5_

- [ ] 6. Исправить адаптивность модальных окон
  - [~] 6.1 Обновить компонент Modal с адаптивными размерами
...
- [ ] 8. Исправить адаптивность карточек категорий
  - [~] 8.1 Обновить компонент CategoryCard с адаптивными классами
  ...
  - [~] 8.3 Написать unit-тест для отображения кнопок действий
...
- [ ] 9. Исправить адаптивность заголовков страниц
  - [~] 9.1 Обновить заголовки на всех страницах с адаптивными классами
  ...
  - [~] 9.2 Написать unit-тесты для заголовков
...
- [ ] 10. Создать адаптивный список транзакций
  - [~] 10.1 Создать компонент TransactionCard для мобильного представления
  ...
  - [~] 10.2 Обновить компонент TransactionList с условным рендерингом
  ...
  - [~] 10.4 Написать unit-тест для интерактивности карточек транзакций
...
- [ ] 12. Добавить глобальные стили и оптимизации
  - [~] 12.1 Обновить globals.css с адаптивными стилями
...
- [ ] 13. Оптимизировать графики для мобильных устройств
  - [~] 13.1 Добавить оптимизацию точек данных для графиков
...
- [ ] 16. Документировать изменения
  - [~] 16.1 Обновить README.md с руководством по адаптивному дизайну
  ...
  - [~] 16.2 Добавить комментарии в код компонентов
