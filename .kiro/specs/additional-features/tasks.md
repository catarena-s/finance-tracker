...
- [ ] 2. Создание моделей данных и миграций БД
  - [ ] 2.1 Создать модель RecurringTransaction
  ...
  - [ ] 2.2 Создать модели Currency и ExchangeRate
...
- [ ] 3. Реализация Pydantic схем
  - [ ] 3.1 Создать схемы для повторяющихся транзакций
...
- [ ] 5. Реализация Service слоя
  - [ ] 5.1 Создать CSVImportService
  ...
  - [ ]* 5.2 Написать property тест для CSVImportService
  ...
  - [ ]* 5.4 Написать property тесты для CSVExportService
  ...
  - [ ] 5.5 Создать RecurringTransactionService
  ...
  - [ ]* 5.6 Написать property тесты для RecurringTransactionService
  ...
  - [ ]* 5.9 Написать property тесты для CurrencyService и ExchangeRateService
  ...
  - [ ] 5.10 Создать CurrencyAPIClient
...
- [ ] 7. Реализация Celery задач
  - [ ] 7.1 Создать celery_app.py
  ...
  - [ ] 7.3 Создать create_recurring_transactions_task
  ...
  - [ ] 7.4 Создать update_exchange_rates_task
...
- [ ] 9. Checkpoint - Убедиться, что все backend тесты проходят
  - Убедиться, что все тесты проходят, спросить пользователя если возникают вопросы.

- [ ] 10. Реализация Frontend компонентов
  - [ ] 10.1 Создать компоненты CSV импорта
  ...
  - [ ] 10.2 Создать компоненты CSV экспорта
  ...
  - [ ] 10.3 Создать компоненты повторяющихся транзакций
  ...
  - [ ]* 10.5 Написать unit тесты для компонентов
...
- [ ] 12. E2E тестирование
  ...
  - [ ]* 12.3 Написать E2E тесты для повторяющихся транзакций
